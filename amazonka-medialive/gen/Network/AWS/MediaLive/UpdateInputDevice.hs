...
data UpdateInputDevice = UpdateInputDevice'{_uidHdDeviceSettings
                                            ::
                                            !(Maybe
...
updateInputDevice
    :: Text -- ^ 'uidInputDeviceId'
    -> UpdateInputDevice
updateInputDevice pInputDeviceId_
  = UpdateInputDevice'{_uidHdDeviceSettings = Nothing,
                       _uidName = Nothing,
...
instance Hashable UpdateInputDevice where

instance NFData UpdateInputDevice where
...
instance ToPath UpdateInputDevice where
        toPath UpdateInputDevice'{..}
          = mconcat
              ["/prod/inputDevices/", toBS _uidInputDeviceId]
...
data UpdateInputDeviceResponse = UpdateInputDeviceResponse'{_uidrsARN
                                                            :: !(Maybe Text),
                                                            _uidrsMACAddress ::
                                                            !(Maybe Text),
...
updateInputDeviceResponse
    :: Int -- ^ 'uidrsResponseStatus'
    -> UpdateInputDeviceResponse
updateInputDeviceResponse pResponseStatus_
  = UpdateInputDeviceResponse'{_uidrsARN = Nothing,
                               _uidrsMACAddress = Nothing,
                               _uidrsHdDeviceSettings = Nothing,
                               _uidrsName = Nothing, _uidrsId = Nothing,
...
instance NFData UpdateInputDeviceResponse where
