...
newtype DescribeInputDevice = DescribeInputDevice'{_didInputDeviceId
                                                   :: Text}
...
describeInputDevice
    :: Text -- ^ 'didInputDeviceId'
    -> DescribeInputDevice
describeInputDevice pInputDeviceId_
  = DescribeInputDevice'{_didInputDeviceId =
                           pInputDeviceId_}
...
instance Hashable DescribeInputDevice where

instance NFData DescribeInputDevice where
...
data DescribeInputDeviceResponse = DescribeInputDeviceResponse'{_didrsARN
                                                                ::
                                                                !(Maybe Text),
                                                                _didrsMACAddress
                                                                ::
...
describeInputDeviceResponse pResponseStatus_
  = DescribeInputDeviceResponse'{_didrsARN = Nothing,
                                 _didrsMACAddress = Nothing,
                                 _didrsHdDeviceSettings = Nothing,
                                 _didrsName = Nothing, _didrsId = Nothing,
...
instance NFData DescribeInputDeviceResponse where
