...
data ListMultiplexPrograms = ListMultiplexPrograms'{_lmpNextToken
                                                    :: !(Maybe Text),
                                                    _lmpMaxResults ::
                                                    !(Maybe Nat),
...
listMultiplexPrograms pMultiplexId_
  = ListMultiplexPrograms'{_lmpNextToken = Nothing,
...
instance Hashable ListMultiplexPrograms where

instance NFData ListMultiplexPrograms where
...
instance ToPath ListMultiplexPrograms where
        toPath ListMultiplexPrograms'{..}
          = mconcat
              ["/prod/multiplexes/", toBS _lmpMultiplexId,
               "/programs"]
...
data ListMultiplexProgramsResponse = ListMultiplexProgramsResponse'{_lmprsNextToken
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
...
listMultiplexProgramsResponse pResponseStatus_
  = ListMultiplexProgramsResponse'{_lmprsNextToken =
                                     Nothing,
...
instance NFData ListMultiplexProgramsResponse where
