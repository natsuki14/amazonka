...
data DescribeReservationResponse = DescribeReservationResponse'{_drrrsState
                                                                ::
                                                                !(Maybe
                                                                    ReservationState),
...
describeReservationResponse pResponseStatus_
  = DescribeReservationResponse'{_drrrsState = Nothing,
                                 _drrrsResourceSpecification = Nothing,
                                 _drrrsCurrencyCode = Nothing,
                                 _drrrsARN = Nothing, _drrrsStart = Nothing,
                                 _drrrsCount = Nothing, _drrrsEnd = Nothing,
                                 _drrrsName = Nothing,
                                 ...
                                 _drrrsDuration = Nothing, _drrrsTags = Nothing,
