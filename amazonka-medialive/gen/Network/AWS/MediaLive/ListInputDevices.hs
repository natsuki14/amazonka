...
data ListInputDevices = ListInputDevices'{_lidNextToken
                                          :: !(Maybe Text),
...
listInputDevices
    :: ListInputDevices
listInputDevices
  = ListInputDevices'{_lidNextToken = Nothing,
...
instance Hashable ListInputDevices where

instance NFData ListInputDevices where
...
data ListInputDevicesResponse = ListInputDevicesResponse'{_lidrsInputDevices
                                                          ::
                                                          !(Maybe
                                                              [InputDeviceSummary]),
                                                          _lidrsNextToken ::
                                                          !(Maybe Text),
                                                          _lidrsResponseStatus
                                                          :: !Int}
...
listInputDevicesResponse
    :: Int -- ^ 'lidrsResponseStatus'
    -> ListInputDevicesResponse
listInputDevicesResponse pResponseStatus_
  = ListInputDevicesResponse'{_lidrsInputDevices =
                                Nothing,
...
instance NFData ListInputDevicesResponse where
