...
data ListReservations = ListReservations'{_lrVideoQuality
                                          :: !(Maybe Text),
...
--
-- * 'lrCodec' - Filter by codec, 'AVC', 'HEVC', 'MPEG2', or 'AUDIO'
--
...
listReservations
    :: ListReservations
listReservations
  = ListReservations'{_lrVideoQuality = Nothing,
                      _lrMaximumFramerate = Nothing,
                      _lrResourceType = Nothing, _lrResolution = Nothing,
                      _lrCodec = Nothing, _lrNextToken = Nothing,
                      _lrSpecialFeature = Nothing,
                      _lrChannelClass = Nothing,
                      _lrMaximumBitrate = Nothing, _lrMaxResults = Nothing}
...
instance Hashable ListReservations where

instance NFData ListReservations where
        ...
        toQuery ListReservations'{..}
          = mconcat
              ["videoQuality" =: _lrVideoQuality,
               ...
               "resolution" =: _lrResolution, "codec" =: _lrCodec,
...
data ListReservationsResponse = ListReservationsResponse'{_lrrsNextToken
                                                          :: !(Maybe Text),
                                                          _lrrsReservations ::
                                                          !(Maybe
                                                              [Reservation]),
...
listReservationsResponse pResponseStatus_
  = ListReservationsResponse'{_lrrsNextToken = Nothing,
...
instance NFData ListReservationsResponse where
