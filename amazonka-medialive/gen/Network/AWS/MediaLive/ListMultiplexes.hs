...
data ListMultiplexes = ListMultiplexes'{_lmNextToken
                                        :: !(Maybe Text),
...
listMultiplexes
    :: ListMultiplexes
listMultiplexes
  = ListMultiplexes'{_lmNextToken = Nothing,
...
instance Hashable ListMultiplexes where

instance NFData ListMultiplexes where
...
data ListMultiplexesResponse = ListMultiplexesResponse'{_lmrsNextToken
                                                        :: !(Maybe Text),
                                                        _lmrsMultiplexes ::
                                                        !(Maybe
                                                            [MultiplexSummary]),
...
listMultiplexesResponse pResponseStatus_
  = ListMultiplexesResponse'{_lmrsNextToken = Nothing,
...
instance NFData ListMultiplexesResponse where
