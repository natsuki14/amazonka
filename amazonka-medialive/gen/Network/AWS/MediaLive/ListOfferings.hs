...
data ListOfferings = ListOfferings'{_loVideoQuality
                                    :: !(Maybe Text),
...
--
-- * 'loCodec' - Filter by codec, 'AVC', 'HEVC', 'MPEG2', or 'AUDIO'
--
...
listOfferings
    :: ListOfferings
listOfferings
  = ListOfferings'{_loVideoQuality = Nothing,
                   _loMaximumFramerate = Nothing,
                   _loResourceType = Nothing,
                   _loChannelConfiguration = Nothing,
                   _loResolution = Nothing, _loCodec = Nothing,
                   _loNextToken = Nothing, _loSpecialFeature = Nothing,
                   _loChannelClass = Nothing,
                   _loMaximumBitrate = Nothing, _loDuration = Nothing,
        ...
        toQuery ListOfferings'{..}
          = mconcat
              ["videoQuality" =: _loVideoQuality,
               ...
               "resolution" =: _loResolution, "codec" =: _loCodec,
