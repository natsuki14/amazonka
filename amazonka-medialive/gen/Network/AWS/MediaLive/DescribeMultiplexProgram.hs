...
data DescribeMultiplexProgramResponse = DescribeMultiplexProgramResponse'{_dmpmrsPacketIdentifiersMap
                                                                          ::
                                                                          !(Maybe
...
describeMultiplexProgramResponse
    :: Int -- ^ 'dmpmrsResponseStatus'
    -> DescribeMultiplexProgramResponse
describeMultiplexProgramResponse pResponseStatus_
  = DescribeMultiplexProgramResponse'{_dmpmrsPacketIdentifiersMap
                                        = Nothing,
